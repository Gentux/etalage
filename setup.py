...
"""Web application based on "PoisCasse" hierarchical database of territories"""
...
setup(
    ...
    long_description = '\n'.join(doc_lines[2:]),
    url = 'http://gitorious.org/infos-pratiques/poiscasse',

    entry_points = """
        [paste.app_factory]
        main = poiscasse.application:make_app

        [paste.app_install]
        main = poiscasse.websetup:Installer
        """,
    ...
    message_extractors = {'poiscasse': [
            ('**.py', 'python', None),
            ('templates/**.mako', 'mako', {'input_encoding': 'utf-8'}),
            ('static/**', 'ignore', None)]},
    package_data = {'poiscasse': ['i18n/*/LC_MESSAGES/*.mo']},
